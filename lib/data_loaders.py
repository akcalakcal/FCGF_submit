...
class ThreeDMatchPairDataset(IndoorPairDataset):
  OVERLAP_RATIO = 0.3
  DATA_FILES = {
      'train': '/vol/research/ucdatasets/MPSD/akin_tmp/src/FCGF/config/train_3dmatch.txt',
      'val': '/vol/research/ucdatasets/MPSD/akin_tmp/src/FCGF/config/val_3dmatch.txt',
      'test': '/vol/research/ucdatasets/MPSD/akin_tmp/src/FCGF/config/test_3dmatch.txt'
  }
